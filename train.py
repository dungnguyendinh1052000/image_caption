...
path_to_desc = "/root/dungnguyendinh/dungnguyendinh/Flickr8k_text/Flickr8k.token.txt"
...
save_descriptions(descriptions, '/root/dungnguyendinh/dungnguyendinh/descriptions.txt')

################################ II. PHẦN ĐỌC ẢNH  ẢNH ############################

path_to_train_id_file = '/root/dungnguyendinh/dungnguyendinh/Flickr8k_text/Flickr_8k.trainImages.txt'
path_to_test_id_file ='/root/dungnguyendinh/dungnguyendinh/Flickr8k_text/Flickr_8k.testImages.txt'
path_to_image_folder = '/root/dungnguyendinh/dungnguyendinh/Flickr8k_Dataset/Flicker8k_Dataset/'
...
for image in all_train_images_in_folder: # Duyệt qua tất cả các file trong folder
    if image.split('/')[-1] in train_images: # Nếu tên file của nó thuộc training set
...
train_descriptions = load_clean_descriptions('/root/dungnguyendinh/dungnguyendinh/descriptions.txt', train_id)
...
def encode(image):
    ...
    fea_vec = model_new.predict(images) # Get the encoding vector for the image
...
def train_features(image):	
  img='/root/dungnguyendinh/dungnguyendinh/Flickr8k_Dataset/Flicker8k_Dataset/'+image
...
f = open('/root/dungnguyendinh/dungnguyendinh/glove.6B.200d.txt', encoding="utf-8")
...
train_features('3765374230_cb1bbee0cb.jpg')
...
for i in range(epochs):
    generator = data_generator(train_descriptions, wordtoix, max_length, number_pics_per_batch)
    model.fit_generator(generator, epochs=1, steps_per_epoch=steps, verbose=1)

# Sau 10 bước train ta lưu weights
model.save_weights('/root/dungnguyendinh/dungnguyendinh/model_30.h5')
